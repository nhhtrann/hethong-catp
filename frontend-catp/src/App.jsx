  ...
  const handleAvatarChange = (info) => {
    if (info.fileList.length > 0) {
      ...
      getBase64(file, (base64ImageUrl) => {
        setPreviewAvatar(base64ImageUrl); 
      });
    }
  };
  ...
  return (
    ...
    >
      <BrowserRouter>
        <Routes>
          {/* ========================================================= */}
          {/* TUYẾN 1: TRANG CÔNG KHAI (LUÔN MỞ CỬA CHO TẤT CẢ) */}
          {/* ========================================================= */}
          <Route path="/" element={<PublicPortal />} />

          {/* ========================================================= */}
          {/* TUYẾN 2: TRANG ĐĂNG NHẬP (Chỉ dành cho ai chưa có userRole) */}
          {/* ========================================================= */}
          <Route path="/login" element={
            !userRole ? <LoginPage onLogin={handleLogin} /> : <Navigate to={userRole === 'admin' ? "/dashboard" : "/bao-cao-ket-qua"} replace />
          } />

          {/* ========================================================= */}
          {/* TUYẾN 3: VÙNG QUẢN TRỊ ADMIN (Chỉ dành cho ai đã có userRole) */}
          {/* ========================================================= */}
          <Route path="/*" element={
            !userRole ? (
                ...
                <div className="main-content" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: 'clamp(10px, 2vw, 24px)', margin: 0, width: '100%', flex: 1, overflowY: 'auto', background: '#f0f2f5' }}>
                    <div className="content-area">
                      <Routes>
                        <Route path="/" element={ 
                          userRole === 'admin' ? <Navigate to="/dashboard" replace /> : <Navigate to="/bao-cao-ket-qua" replace />
                        } />
